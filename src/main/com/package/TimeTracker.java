...
public class TimeTracker {
    ...
    public static void main(String[] args) {
        ...
        displayWeeklySummary(ename, employeeID);
    ...
    public static void displayWeeklySummary(String ename, String employeeID) {
        // Display employee information
        System.out.println("\nWeekly Time Summary for " + ename + " (ID: " + employeeID + "):");
